...
from myhermes_audit.contracts import TurnResult
...
def _execute(request: MyHermesWorkerRequest) -> MyHermesWorkerResult:
    ...
    try:
        ...
        for turn_number, user_message in enumerate(request.turns, start=1):
        ...
        if process_manager is not None:
            try:
                lifecycle_warnings = close_runtime_resources(
